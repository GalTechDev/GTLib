...
#load all textur
#root.mesh.add_cube_texture(dir_path="GT3D/Graphics_Engine/textures/env", name="test")
root.mesh.add_cube_texture(color=["blue","red","black","white","green","grey"], name="c_gray")


#load mesh
root.mesh.add_obj(root.ctx, path="GT3D/Graphics_Engine/objects/cat/20430_Cat_v1_NEW.obj", name="chat")
