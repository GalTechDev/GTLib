...
class BaseModel:
    ...
    def get_mass(self):
        return self.mase_vol*((2*self.scale[0])*(2*self.scale[1])*(2*self.scale[2]))
...
class EnvBox(BaseModel):
    def __init__(self, app, vao_name='env', tex_id='env',
